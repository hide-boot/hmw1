...
{    
    ...
    $squery="SELECT id FROM posts_serie WHERE content='".$_POST['hidden']."'";
    ...
    if(isset($_COOKIE['id'])){
    $query="INSERT INTO comments_serie(userc,post,text) VALUES('".$_COOKIE['id']."','".$value['0']."','$escape')";
    }
    if(isset($_SESSION['id'])){
        $query="INSERT INTO comments_serie(userc,post,text) VALUES('".$_SESSION['id']."','".$value['0']."','".$escape."')";
    }
