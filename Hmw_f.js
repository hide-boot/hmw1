...
fetch('prefer.php').then(onResponce).then(onPrefer);
...
fetch("api_film.php?q=inception&m=s&type=f").then(onResponce).then(onSearch);
fetch("api_film.php?q=john+wick&m=s&type=f").then(onResponce).then(onSearch);
fetch("api_film.php?q=gemini+man&m=s&type=f").then(onResponce).then(onSearch);
fetch("api_film.php?q=the+lord+of+the+rings&m=s&type=f").then(onResponce).then(onSearch);
fetch("api_film.php?q=sicario&m=s&type=f").then(onResponce).then(onSearch);
fetch("api_film.php?q=6+underground&m=s&type=f").then(onResponce).then(onSearch);
fetch("api_film.php?q=shutter+island&m=s&type=f").then(onResponce).then(onSearch);
...
function search(event)
{
   event.preventDefault();
    ...
    else
    {
        ...
        const link=encodeURI("api_film.php?q="+valuecode+"&m=s&type=f");
   ...
   function onSearch(json)
{
  ...
  for(let i=0;i<json.Search.length;i++){
   ...
   {   
       ...
       fetch("api_film.php?q="+title+"&m=t&type=f").then(onResponce).then(onMore);
...
function add(event){
   ...
   fetch('inprefer.php',{method:'post',body:formdata}).then(onRes);
...
function onComment(event){
    ...
    fetch('oncomment.php?title='+get).then(onResponce).then(CommentJson);
}
...
function onPrefer(json){
    for(let i=0;i<json.length;i++){
        ...
        fetch("api_film.php?q="+uri+"&m=t&type=f").then(onResponce).then(Prefe)
...
function Send(event){
    ...
    fetch('insertcomment.php',{method:'post',
    body:formdata
    }).then(onResponce)
}
